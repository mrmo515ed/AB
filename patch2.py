...
import re
m2 = re.search(r'if\(S\.page === \'chatRoom\' && S\.params\.id\) \{\s*const msgBox = document\.getElementById\("msgs"\);.*?msgBox\.scrollTop = msgBox\.scrollHeight;\s*\}\s*\}\s*\}\s*\}\s*\}', text, re.DOTALL)
if m2:
